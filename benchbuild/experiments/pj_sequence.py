...
def persist_sequence(run_info_func, sequence, fitness_val):
    """
    Persist the sequence and its fitness value in the database.

    Args:
        run_info_func: A function that compiles the first command
                       and returns the run info needed for the session.
