...
from benchbuild.downloads.versions import BaseVersionGroup
...
class Project(metaclass=ProjectDecorator):
    ...
    VARIANTS = None
    variants: BaseVersionGroup = attr.ib(default=attr.Factory(
        lambda self: type(self).VARIANTS, takes_self=True))
