...
CFG = s.Configuration(
    ...
    node={
        ...
        "debug": {"desc": "Should debug logging be enabled?", "default": False},
        "config_file": {
        ...
        "force_tty": {"desc": "Assume an active TTY.", "default": False},
...
CFG["compiler"] = {
    "c": {"desc": "The C compiler we should use.", "default": "clang"},
    "cxx": {"desc": "The C++ compiler we should use.", "default": "clang++"},
}
...
CFG["unionfs"] = {
    ...
    "rw": {"default": "rw", "desc": "Name of the image directory"},
}
...
CFG["db"] = {
    "enabled": {"desc": "Whether the database is enabled.", "default": False},
    "connect_string": {"desc": "sqlalchemy connect string", "default": "sqlite://"},
    "rollback": {
...
CFG["gentoo"] = {
    ...
    "http_proxy": {"default": None, "desc": "HTTP Proxy to use for downloads."},
    "rsync_proxy": {"default": None, "desc": "RSYNC Proxy to use for downloads."},
    "ftp_proxy": {"default": None, "desc": "FTP Proxy to use for downloads."},
}

CFG["slurm"] = {
    "account": {"desc": "The SLURM account to use by default.", "default": "cl"},
    "partition": {
    ...
    "script": {
        "desc": "Name of the script that can be passed to SLURM. Used by external "
        "tools.",
        "default": "slurm.sh",
    },
    "cpus_per_task": {
    ...
    "logs": {"desc": "Location the SLURM logs will be stored", "default": "slurm.log"},
    "nice": {"desc": "Add a niceness value on our priority", "default": 0},
    "nice_clean": {
    ...
    "container_runroot": {"default": None, "desc": "Runtime storage for containers"},
}
...
CFG["container"] = {
    ...
    "replace": {"default": False, "desc": "Replace existing container images."},
    "export": {
        "default": s.ConfigPath(os.path.join(os.getcwd(), "containers", "export")),
    ...
    "storage_driver": {
        "default": None,
        "desc": "Storage driver for containers.If 'null' use podman's default.",
    },
    "storage_opts": {
        "default": [],
    ...
    "images": {"default": {"gentoo": "gentoo.tar.bz2", "ubuntu": "ubuntu.tar.bz2"}},
    "prefered": {
        "default": [],
...
CFG["container"]["strategy"] = {"dummy": {"default": None, "desc": "dummy value"}}
        ...
        "default": [
            {
                ...
                "env": {"ACCEPT_KEYWORDS": "~amd64", "USE": "-filecaps"},
            },
            ...
            {"name": "net-misc/curl", "env": {}},
            {
                ...
                "env": {"USE": "-filecaps", "ACCEPT_KEYWORDS": "~amd64"},
            },
            {
                "name": "dev-libs/libpfm",
                "env": {"USE": "static-libs", "ACCEPT_KEYWORDS": "~amd64"},
            },
            ...
            {"name": "=dev-libs/boost-1.62-r1", "env": {"ACCEPT_KEYWORDS": "~amd64"}},
            {"name": "dev-libs/libpqxx", "env": {}},
            {"name": "dev-lang/python-3.5.3", "env": {"ACCEPT_KEYWORDS": "~amd64"}},
            {"name": "dev-python/dill", "env": {"ACCEPT_KEYWORDS": "~amd64"}},
        ],
...
CFG["coverage"] = {
    ...
    "config": {"desc": "Where is the coverage config?", "default": ".coveragerc"},
    "path": {"desc": "Where should the coverage files be placed?", "default": None},
}
