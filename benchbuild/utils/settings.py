...
def to_yaml(value) -> Optional[str]:
...
def to_env_var(env_var: str, value: Any) -> str:
    """
...
def convert_components(value: Union[str, List[str]]) -> List[str]:
...
def find_config(test_file: Optional[str] = None,
                defaults: Optional[List[str]] = None,
                root: str = os.curdir) -> Optional[LocalPath]:
    """
