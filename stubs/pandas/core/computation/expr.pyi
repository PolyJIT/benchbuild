...
class BaseExprVisitor(ast.NodeVisitor):
    ...
    def visit_Constant(self, node: Any, **kwargs: Any): ...
    ...
    def visit_Call(self, node: Any, side: Optional[Any] = ..., **kwargs: Any): ...
...
class PythonExprVisitor(BaseExprVisitor):
    def __init__(self, env: Any, engine: Any, parser: Any, preparser: Any = ...): ...
