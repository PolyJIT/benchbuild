...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    @property
    def size(self): ...
    def set_axis(self, labels: Any, axis: int = ..., inplace: bool = ...): ...
    ...
    def to_json(self, path_or_buf: Optional[FilePathOrBuffer]=..., orient: Optional[str]=..., date_format: Optional[str]=..., double_precision: int=..., force_ascii: bool_t=..., date_unit: str=..., default_handler: Optional[Callable[[Any], JSONSerializable]]=..., lines: bool_t=..., compression: Optional[str]=..., index: bool_t=..., indent: Optional[int]=...) -> Optional[str]: ...
    ...
    def to_xarray(self): ...
    def to_latex(self, buf: Optional[Any] = ..., columns: Optional[Any] = ..., col_space: Optional[Any] = ..., header: bool = ..., index: bool = ..., na_rep: str = ..., formatters: Optional[Any] = ..., float_format: Optional[Any] = ..., sparsify: Optional[Any] = ..., index_names: bool = ..., bold_rows: bool = ..., column_format: Optional[Any] = ..., longtable: Optional[Any] = ..., escape: Optional[Any] = ..., encoding: Optional[Any] = ..., decimal: str = ..., multicolumn: Optional[Any] = ..., multicolumn_format: Optional[Any] = ..., multirow: Optional[Any] = ..., caption: Optional[Any] = ..., label: Optional[Any] = ...): ...
    ...
    def where(self, cond: Any, other: Any = ..., inplace: bool = ..., axis: Optional[Any] = ..., level: Optional[Any] = ..., errors: str = ..., try_cast: bool = ...): ...
    def mask(self, cond: Any, other: Any = ..., inplace: bool = ..., axis: Optional[Any] = ..., level: Optional[Any] = ..., errors: str = ..., try_cast: bool = ...): ...
