...
def urlopen(*args: Any, **kwargs: Any): ...
def get_filepath_or_buffer(filepath_or_buffer: FilePathOrBuffer, encoding: Optional[str]=..., compression: Optional[str]=..., mode: Optional[str]=...) -> Any: ...
...
class _BytesZipFile(zipfile.ZipFile, BytesIO):
    archive_name: Any = ...
    def __init__(self, file: FilePathOrBuffer, mode: str, archive_name: Optional[str]=..., **kwargs: Any) -> None: ...
